...
Alternatively, install the app with `neko-player-setup-1.1.0.exe`. The installer supports common audio and video file associations, registers neko player as a candidate under Windows Settings → Default Apps, and adds “Open with neko player” to File Explorer's context menu.
